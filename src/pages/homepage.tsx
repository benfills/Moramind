    ...
    <div className="relative flex min-h-dvh w-full flex-col items-center gap-10 bg-(--bg-primary) px-4 py-12">
      <hgroup className="flex w-full flex-col items-center justify-center gap-4 text-center">
        <h1 className="max-w-[90vw] sm:max-w-130">
          <span
            className="leading-tight font-bold text-(--text-primary)"
            style={{ fontSize: "clamp(2rem, 6vw, 3.5rem)" }}
          >
            Brains adapt.{" "}
          </span>
          <span
            className="leading-tight font-normal text-(--text-secondary)"
      ...
      <div className="dbg1 relative top-25 mx-auto w-full max-w-125.5">
        <div className="absolute flex aspect-502/324 w-full flex-col items-center justify-center rounded-lg bg-(--bg-secondary)">
          {/* TODO: add captions .vtt once real video is ready */}
